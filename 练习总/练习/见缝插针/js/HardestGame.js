...
(function () {
    ...
    if (!window["extendClass"]) {
        window["extendClass"] = function (sonClass, parentClass) {
            if (typeof parentClass === "function" && typeof sonClass === "function") {
                sonClass.prototype = new ((function () {
                }).prototype = parentClass.prototype).constructor();
    ...
    Game.prototype = {
        ...
        init: function () {
            ...
            var self = this;
            this.mobileTouch = new JicemoonMobileTouch(this.canvas, {
                tap: function (evt) {
